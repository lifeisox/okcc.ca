...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=P;var e=s(require("lodash/debounce")),t=s(require("lodash/includes")),n=s(require("lodash/isString")),r=s(require("lodash/keys")),i=s(require("lodash/forEach")),o=s(require("lodash/remove")),d=s(require("lodash/isEmpty")),u=s(require("lodash/merge")),a=s(require("lodash/some")),l=s(require("lodash/get")),c=s(require("lodash/set"));function s(e){return e&&e.__esModule?e:{default:e}}var f=window.top&&window.top!==window.self,w={},v={};function h(){var e=jQuery._data(window,"events");e&&e.resize&&(0,i.default)(e.resize,function(e){e.handler._et_wrapped||(e.handler=_(e.handler))})}function p(e){var n=(0,l.default)(ET_Builder,"Preboot.overrides.".concat(e),[]),r=(0,t.default)(n,"app"),i=(0,t.default)(n,"top");return r&&f||i&&!f}function m(){var e=new MutationObserver(function(e){(0,i.default)(e,function(e){(0,i.default)(e.addedNodes,function(e){if("SCRIPT"===e.nodeName&&ET_Builder.Preboot.exclude_scripts.enabled){var t=ET_Builder.Preboot.exclude_scripts.match,n=!1;e.innerHTML&&(0,a.default)(t,function(t){return t.test(e.innerHTML)})?n=!0:(0,a.default)(t,function(t){return t.test(e.src)})&&(n=!0),n&&e.parentNode.removeChild(e)}})})});e.observe(document,{childList:!0,subtree:!0}),window.addEventListener("et_fb_root_did_mount",function(t){return e.disconnect()})}function _(t){var n=arguments.length>1&&void 0!==arguments[1]&&arguments[1],r=!t.cancel,i=!1,o=function(e,n){if(n&&t.flush)t.flush();else if(!window.ET_Builder.API.State.View_Mode.isAnimating())return t.apply(this,arguments)};r&&(o=(0,e.default)(o,350,{leading:!1}));var d=function(e){window.ET_Builder.API.State&&(!i&&window.ET_Builder.API.State.View_Mode.isAnimating()?i=!0:i&&!window.ET_Builder.API.State.View_Mode.isAnimating()?(i=!1,o.flush?o.flush():o.call(this,e,!0)):o.call(this,e))};return t._et_wrapped=!0,d.guid=t.guid||(t.guid=jQuery.guid++),d._et_wrapped=!0,n&&(v[d.guid]=d),d}function g(e,t){return p("document.createElement")?("script"===e.toLowerCase()&&(e="noscript"),w.document.createElement.call(document,e,t)):w.document.createElement.call(document,e,t)}var y=function(e){return(0,l.default)(window,"ET_Builder.Preboot.writes",[]).push(e)};function E(e,t){for(var n,r,i=arguments.length,o=new Array(i>2?i-2:0),d=2;d<i;d++)o[d-2]=arguments[d];return p("window.addEventListener")?("resize"!==e||t._et_wrapped||(t=_(t,!0)),(n=w.window.addEventListener).call.apply(n,[window,e,t].concat(o))):(r=w.window.addEventListener).call.apply(r,[window,e,t].concat(o))}function j(e,t){for(var n,r,i=arguments.length,o=new Array(i>2?i-2:0),d=2;d<i;d++)o[d-2]=arguments[d];return p("window.removeEventListener")?("resize"===e&&t._et_wrapped&&(t=v[t.guid],delete v[t.guid]),(n=w.window.removeEventListener).call.apply(n,[window,e,t].concat(o))):(r=w.window.removeEventListener).call.apply(r,[window,e,t].concat(o))}function L(e,u){var a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;if(!p("jquery.on"))return w.jquery.on.call(this,e,u,a,l);var c=jQuery.isWindow(this[0]),s=(0,n.default)(e),f=s?(0,t.default)(e,"resize"):(0,t.default)((0,r.default)(e),"resize");if(!c||!f)return w.jquery.on.apply(this,arguments);if(null===a&&null===l?(l=u,a=u=void 0):null===l&&(0,n.default)(u)?(l=a,a=void 0):null===l&&(l=a,a=u,u=void 0),s){var v=e.split(" "),h=(0,o.default)(v,function(e){return(0,t.default)(e,"resize")}),m=_(l);e=v.join(" "),w.jquery.on.call(this,h.join(" "),u,a,m)}else(0,i.default)(e,function(e,n){(0,t.default)(n,"resize")&&(e=_(e))});return(0,d.default)(e)?void 0:w.jquery.on.call(this,e,u,a,l)}function q(e){var n=this.attr("style");return(0,t.default)(n,e)?this:(this.css("cssText","".concat(n," ").concat(e)),this)}function T(e){return function(){try{for(var t,n=arguments.length,r=new Array(n),i=0;i<n;i++)r[i]=arguments[i];return(t=(0,l.default)(w,"jquery.".concat(e))).call.apply(t,[this].concat(r))}catch(o){return console.error(o)}}}function b(){m(),(0,u.default)(w,{document:{createElement:document.createElement},window:{addEventListener:window.addEventListener,removeEventListener:window.removeEventListener}}),f?(window.addEventListener=E,window.removeEventListener=j):document.createElement=g,document.write=y}function Q(){(0,u.default)(w,{jquery:{on:jQuery.fn.on,trigger:jQuery.fn.trigger,triggerHandler:jQuery.fn.triggerHandler}}),f&&(jQuery.fn.on=L,jQuery.fn.cssText=q,window.top&&(window.top.jQuery.fn.cssText=q),h()),jQuery.fn.trigger=T("trigger"),jQuery.fn.triggerHandler=T("triggerHandler"),jQuery(window).on("et_fb_root_did_mount",function(e){(0,i.default)([window,window.top],function(e){return(0,c.default)(e,"ET_Builder.Preboot.overrides.document.createElement",[])})})}function P(){b(),document.addEventListener("DOMContentLoaded",Q)}
...
"use strict";var e=u(require("lodash/forEach")),o=u(require("lodash/startsWith")),n=u(require("lodash/find")),t=u(require("lodash/endsWith")),d=u(require("lodash/get")),i=u(require("lodash/merge")),a=u(require("lodash/includes")),r=u(require("./lib/overrides"));function u(e){return e&&e.__esModule?e:{default:e}}var c=window.top&&window.top!==window.self,l=(0,d.default)(window,"et_webpack_bundle.preload",[]),s=window.et_fb_preboot.debug||!(0,n.default)(l,function(e){return(0,t.default)(e,".css")});window.ET_Builder=(0,i.default)(window.ET_Builder||{},{API:{},Frames:{},Misc:{},Preboot:{exclude_scripts:{enabled:!0,match:{innerHTML:/document\.location *=|googletagmanager\.com|apex\.live|hotjar\.com|jQuery\.noConflict/i,src:/googletagmanager\.com|apex\.live|hotjar\.com|mailchimp\.com/i}},overrides:{document:{createElement:["top"]},jquery:{on:["app"]},window:{addEventListener:["app"],removeEventListener:["app"]}},writes:[]}}),c&&(window.__REACT_DEVTOOLS_GLOBAL_HOOK__=window.top.__REACT_DEVTOOLS_GLOBAL_HOOK__),(0,r.default)(c),document.addEventListener("DOMContentLoaded",function(n){(c?window.ET_Builder.Frames.app=window:(!(0,a.default)(window.location.href,"PageSpeed=off")&&document.head.innerHTML.match(/\.pagespeed\..+?\.js/)&&(window.location.href="".concat(window.location.href,"&PageSpeed=off")),ET_Builder.Misc.original_body_class=document.body.className),c&&s)?(new MutationObserver(function(n){(0,e.default)(n,function(n){(0,e.default)(n.addedNodes,function(e){"LINK"===e.nodeName&&(0,o.default)(e.href,"blob:")&&window.top.jQuery("head").append(jQuery(e).clone())})})}).observe(document.head,{childList:!0}),et_fb_preboot.is_BFB&&jQuery('head link[href^="blob:"]').each(function(){window.top.jQuery("head").append(jQuery(this).clone())})):c||window.addEventListener("load",function(){var e;"function"!=typeof Event?(e=document.createEvent("Event")).initEvent("ETDOMContentLoaded",!0,!0):e=new Event("ETDOMContentLoaded"),document.dispatchEvent(e)})});
